...
sprites_colls_demo_str: .text @"sprites collisions demo. move joystick\$00"
sprites_player_y_str:   .text @"player cent y:\$00"
sprites_player_x_str:   .text @"player cent x:\$00"
sprites_enemy_y_str:   .text @"enemy y:\$00"
sprites_enemy_x_str:   .text @"enemy x:\$00"
sprites_enemy_n_str:   .text @"enemy number:\$00"
