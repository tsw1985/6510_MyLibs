...
welcome_demo_str:       .text @"bienvenidos a mi super demo\$00"
welcome_user_str:       .text @"hola\$00"
write_name_str:         .text @"cual es tu nombre?\$00"
start_game_str:         .text @"pulsa intro para empezar a jugar\$00"
